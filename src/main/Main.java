...
/*
        ...
        System.out.println("OPERARIO TEST :"+Datos.operario);
        
        variable1 = teclado.nextLine();
        variable2 = teclado.nextLine();
        Operario operarioTest= new Operario(variable1,variable2) ;
        Datos.setOperario(operarioTest);
        System.out.println("OPERARIO TEST :"+Datos.operario);
        ...
        operarioregistradounico = new Operario(fechatest,76123, "contraop", "nombreop", "appelidoop", "codigoop");
        ...
        do {
            ...
            switch (op1) {
                ...
                case 1: //Alumno
                    ...
                    // sistema.getAlumnosRegistrados().verificarAlumno(contraseña, codigo)
                    //alumnotest.logearse(contraseña, codigo, sistema.getAlumnosRegistrados())
                    if ( sistema.getAlumnosRegistrados().verificarAlumno(contraseña, codigo)== true) {
